...
<body>
 ...
 <form enctype="multipart/form-data" name="uploadform" method="post" action="registrarcategory.php">
 ...
 <?php
$con->generarSelect("departament","txtcategoria");
 ?>
 </td></tr>
    <tr><td>
