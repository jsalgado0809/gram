...
<body>
 ...
 <form enctype="multipart/form-data" name="uploadform" method="post" action="registrarstudent.php">
 ...
 <input type="text" name="txtcuenta" required />
 </td></tr>
  <tr><td>
 <h1>Fecha de Nacimiento</h1>
 </td><td>
 <input type="date" name="txtnacimiento" required />
 </td></tr>
 ...
 <h1>Imagen</h1>
	...
	<input type="file" name="userfile" id="userfile" accept="image/jpeg,image/x-png,image/gif" />
 </td></tr>
    <tr><td>
