...
function change(){
  ...
  location.href="flujograma.php?career_id="+myselect.options[myselect.selectedIndex].value;
}
</script>
...
Canvas not supported by your browser.
 ...
 <?php
$con->generarSelect7("career","txtcareer");
 ?>
 </td></tr>
...
(function(){
	...
	var jsarray;
	 ...
	 ctx.fillStyle=' rgba(164, 184, 179, 1)';
		...
		ctx.fillStyle='#000';
		console.log(this.y-0);console.log(this.y+0);
		var x=parseInt(this.x)+5;
		var y=parseInt(this.y)+20;
