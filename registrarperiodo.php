...
<body>
 ...
 <form enctype="multipart/form-data" name="uploadform" method="post" action="registrarperiodo.php">
 
 <table width="400px" border="0" align="center">
 <tr><td>
 <h1>Nombre</h1>
 </td><td>
<select name="txtnombre" required>
 ...
 <input type="number" name="txtanio" required />
 </td></tr>
    <tr><td>
