...
<body>
 ...
 <form enctype="multipart/form-data" name="uploadform" method="post" action="registrarseccion.php">
 
 <table width="400px" border="0" align="center">
  <tr><td>
 <h1>Codigo</h1>
 </td><td>
 <input type="text" max="4" name="txtcode" required />
 </td></tr>
   <tr><td>
 <h1>Maestro</h1>
 </td><td>
 <?php
$con->generarSelect("teachers","txtteacher");
 ?>
 </td></tr>
    <tr><td>
 <h1>Asignatura</h1>
...
$con->generarSelect("asignature","txtasignature");
 ...
 <?php
$con->generarSelect2("period","txtperiod");
 ?>
 </td></tr>
   <tr><td>
 <h1>Numero de Estudiantes</h1>
 </td><td>
 <input type="number" name="txtmax" required />
 </td></tr>
    <tr><td>
